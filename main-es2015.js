...
let ContentTilesetComponent = class ContentTilesetComponent {
    ...
    /* Filters */
    returnCorrespondingFilters(content) {
        // find matches between each filter.connected && content.id;
        const listOfFilters = [];
        const listOfFiltersText = [];
        for (const correspondingFilter of dictionaries_filter_dict__WEBPACK_IMPORTED_MODULE_3__["FILTERS"]) {
...
DongHeaderComponent.ctorParameters = () => [
...
let DongRouterComponent = class DongRouterComponent {
    constructor() {
